...
main(void){
    ...
    1020:	6a 05                	push   $0x5
    1022:	53                   	push   %ebx
    1023:	e8 2b 03 00 00       	call   1353 <mprotect>
    munprotect(ptr, PAGES_NUM);
    1028:	59                   	pop    %ecx
    1029:	58                   	pop    %eax
    102a:	6a 05                	push   $0x5
    102c:	53                   	push   %ebx
    102d:	e8 29 03 00 00       	call   135b <munprotect>
    
    ptr[PGSIZE * 1] = 0xAA;
    1032:	c6 83 00 10 00 00 aa 	movb   $0xaa,0x1000(%ebx)
    printf(1, "XV6_TEST_OUTPUT TEST PASS\n");
    1039:	58                   	pop    %eax
    103a:	5a                   	pop    %edx
    103b:	68 48 17 00 00       	push   $0x1748
    1040:	6a 01                	push   $0x1
    1042:	e8 d9 03 00 00       	call   1420 <printf>

    exit();
    1047:	e8 57 02 00 00       	call   12a3 <exit>
