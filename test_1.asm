...
main(int argc, char *argv[])
{
  ...
  if(getpinfo(&st) == 0)
    100e:	8d 85 f8 fb ff ff    	lea    -0x408(%ebp),%eax
{
    1014:	81 ec 10 04 00 00    	sub    $0x410,%esp
  if(getpinfo(&st) == 0)
    101a:	50                   	push   %eax
    101b:	e8 23 03 00 00       	call   1343 <getpinfo>
    1020:	83 c4 10             	add    $0x10,%esp
    1023:	85 c0                	test   %eax,%eax
    1025:	75 16                	jne    103d <main+0x3d>
  {
   printf(1, "XV6_SCHEDULER\t SUCCESS\n");
    1027:	52                   	push   %edx
    1028:	52                   	push   %edx
    1029:	68 48 17 00 00       	push   $0x1748
    102e:	6a 01                	push   $0x1
    1030:	e8 eb 03 00 00       	call   1420 <printf>
  ...
  else
  {
   ...
   exit();
    1038:	e8 66 02 00 00       	call   12a3 <exit>
   printf(1, "XV6_SCHEDULER\t FAILED\n");
    103d:	50                   	push   %eax
    103e:	50                   	push   %eax
    103f:	68 60 17 00 00       	push   $0x1760
    1044:	6a 01                	push   $0x1
    1046:	e8 d5 03 00 00       	call   1420 <printf>
    104b:	83 c4 10             	add    $0x10,%esp
    104e:	eb e8                	jmp    1038 <main+0x38>
