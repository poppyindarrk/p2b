...
main(int argc, char **argv)
{
  ...
  exit();
    ...
    104a:	50                   	push   %eax
    104b:	50                   	push   %eax
    104c:	68 58 17 00 00       	push   $0x1758
    1051:	6a 02                	push   $0x2
    1053:	e8 d8 03 00 00       	call   1430 <printf>
    exit();
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15d1:	a1 84 1a 00 00       	mov    0x1a84,%eax
{
  ...
  freep = p;
    ...
    1611:	5b                   	pop    %ebx
  freep = p;
    1612:	89 15 84 1a 00 00    	mov    %edx,0x1a84
}
    1618:	5e                   	pop    %esi
    1619:	5f                   	pop    %edi
    161a:	5d                   	pop    %ebp
  ...
  freep = p;
    164c:	89 15 84 1a 00 00    	mov    %edx,0x1a84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    166c:	8b 3d 84 1a 00 00    	mov    0x1a84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16b1:	8b 3d 84 1a 00 00    	mov    0x1a84,%edi
  ...
  return freep;
    16df:	8b 15 84 1a 00 00    	mov    0x1a84,%edx
    ...
    170c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    170f:	89 15 84 1a 00 00    	mov    %edx,0x1a84
}
    ...
    171f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1720:	c7 05 84 1a 00 00 88 	movl   $0x1a88,0x1a84
    1727:	1a 00 00 
    base.s.size = 0;
    172a:	bf 88 1a 00 00       	mov    $0x1a88,%edi
    base.s.ptr = freep = prevp = &base;
    172f:	c7 05 88 1a 00 00 88 	movl   $0x1a88,0x1a88
    1736:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    173b:	c7 05 8c 1a 00 00 00 	movl   $0x0,0x1a8c
    1742:	00 00 00 
    if(p->s.size >= nunits){
