...
main(int argc, char *argv[])
{
   ...
   if(getpinfo((struct pstat *)1000000) == -1)
    ...
    1016:	e8 28 03 00 00       	call   1343 <getpinfo>
    101b:	83 c4 10             	add    $0x10,%esp
    101e:	83 f8 ff             	cmp    $0xffffffff,%eax
    1021:	74 16                	je     1039 <main+0x39>
   {
   ...
   else
   {
    ...
    1023:	50                   	push   %eax
    1024:	50                   	push   %eax
    1025:	68 60 17 00 00       	push   $0x1760
    102a:	6a 01                	push   $0x1
    102c:	e8 ef 03 00 00       	call   1420 <printf>
    1031:	83 c4 10             	add    $0x10,%esp
   }
   
   exit();
    1034:	e8 6a 02 00 00       	call   12a3 <exit>
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");
    1039:	52                   	push   %edx
    103a:	52                   	push   %edx
