...
main(void){
    ...
    1017:	e8 0f 03 00 00       	call   132b <sbrk>
    ...
    1020:	6a 05                	push   $0x5
    1022:	53                   	push   %ebx
    1023:	e8 33 03 00 00       	call   135b <munprotect>
    ptr[PGSIZE * 3] = 0xAA;
    1028:	c6 83 00 30 00 00 aa 	movb   $0xaa,0x3000(%ebx)
    printf(1, "XV6_TEST_OUTPUT TEST PASS\n");
    102f:	59                   	pop    %ecx
    1030:	5b                   	pop    %ebx
    1031:	68 48 17 00 00       	push   $0x1748
    1036:	6a 01                	push   $0x1
    1038:	e8 e3 03 00 00       	call   1420 <printf>
    exit();
    103d:	e8 61 02 00 00       	call   12a3 <exit>
    1042:	66 90                	xchg   %ax,%ax
    1044:	66 90                	xchg   %ax,%ax
    ...
    137c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13a9:	0f b6 92 c4 17 00 00 	movzbl 0x17c4(%edx),%edx
    ...
    1429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1499:	ff 24 85 6c 17 00 00 	jmp    *0x176c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    15a7:	90                   	nop
          s = "(null)";
    15a8:	ba 63 17 00 00       	mov    $0x1763,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15c1:	a1 70 1a 00 00       	mov    0x1a70,%eax
{
  ...
  freep = p;
    ...
    1601:	5b                   	pop    %ebx
  freep = p;
    1602:	89 15 70 1a 00 00    	mov    %edx,0x1a70
}
    1608:	5e                   	pop    %esi
    1609:	5f                   	pop    %edi
    160a:	5d                   	pop    %ebp
  ...
  freep = p;
    163c:	89 15 70 1a 00 00    	mov    %edx,0x1a70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    165c:	8b 3d 70 1a 00 00    	mov    0x1a70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16a1:	8b 3d 70 1a 00 00    	mov    0x1a70,%edi
  ...
  return freep;
    16cf:	8b 15 70 1a 00 00    	mov    0x1a70,%edx
    ...
    16fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    16ff:	89 15 70 1a 00 00    	mov    %edx,0x1a70
}
    ...
    170f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1710:	c7 05 70 1a 00 00 74 	movl   $0x1a74,0x1a70
    1717:	1a 00 00 
    base.s.size = 0;
    171a:	bf 74 1a 00 00       	mov    $0x1a74,%edi
    base.s.ptr = freep = prevp = &base;
    171f:	c7 05 74 1a 00 00 74 	movl   $0x1a74,0x1a74
    1726:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    172b:	c7 05 78 1a 00 00 00 	movl   $0x0,0x1a78
    1732:	00 00 00 
    if(p->s.size >= nunits){
